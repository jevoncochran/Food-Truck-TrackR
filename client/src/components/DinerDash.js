            ...
            <div className="trucks-by-category-div">
              <Grid className="trucks-by-type-grid" container spacing={4}>
                {props.trucksByType.map((truck) => (
                  <Grid item xs={4}>
                    <Card
                      className="trucks-by-category-card"
                    ...
                    >
                      <CardActionArea>
                        ...
                        <i
                          className="like-icon"
                          class={
                            filterThroughFavs(truck.id).length > 0
                              ? "fas fa-heart"
                              : "far fa-heart"
                          }
                          onClick={
                            filterThroughFavs(truck.id).length > 0
                              ? (e) => removeFromFavorites(e, truck.id)
                              : (e) => addToFavs(e, truck.id)
                          }
                        />
                        <CardContent>
                          <Typography
                            className="trucks-by-category-name"
                            gutterBottom
                            variant="h5"
                            component="h2"
                          >
        ...
        <div className="card-div">
          <div className="card-sub-div">
            ...
            <div className="trucks-div">
              {props.trucks &&
                props.trucks
                  .slice(sliceParams.nearbyStart, sliceParams.nearbyEnd)
                  .map((truck) => (
                    <Card
                    ...
                    >
                      <CardActionArea>
                        ...
                        <CardContent>
                          ...
                          <Typography
                            className="distance-plus-rating"
                            component="h3"
                          >
                            {truckDistance[truck.index]}
                            {/* {console.log(`props.location: ${props.location}, truck.current_location: ${truck.current_location}, returns: ${getTruckDistance(props.location, truck.current_location)}`)}
        ...
        <div className="card-div">
          <div className="card-sub-div">
            ...
            <div className="trucks-div">
              {props.favTrucks &&
                props.favTrucks
                  .slice(sliceParams.favsStart, sliceParams.favsEnd)
                  .map((truck) => (
                    <Card
                      className="truck-card"
                      onClick={() => selectTruck(truck.id)}
