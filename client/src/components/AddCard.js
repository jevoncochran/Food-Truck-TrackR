...
const AddCard = (props) => {
  ...
  useEffect(() => {
    console.log(
      `card to add: ${cardToAdd.name}, ${cardToAdd.num}, ${cardToAdd.exp_date}, ${cardToAdd.cvc}, ${cardToAdd.zip}`
    );
  }, [cardToAdd]);
      ...
      <div style={modalStyle} className={classes.paper}>
        <div className="add-card-body">
          ...
          <form onSubmit={addCard}>
            <label htmlFor="number" style={{ marginBottom: "2%" }}>
              Card Number
            </label>
            <input
              type="tel"
              ...
              value={cardToAdd.num}
              onChange={(e) =>
                setCardToAdd({ ...cardToAdd, num: e.target.value })
              }
            ...
            <input
              ...
              onChange={(e) =>
                setCardToAdd({ ...cardToAdd, name: e.target.value })
              }
              onFocus={(e) => setFocus(e.target.name)}
              ...
              <div className="exp-sec-input-div">
                <div className="exp-input-div">
                  <input
                    ...
                    onChange={(e) =>
                      setCardToAdd({ ...cardToAdd, exp_date: e.target.value })
                    }
                    onFocus={(e) => setFocus(e.target.name)}
                  />
                </div>
                ...
                <div className="sec-input-div">
                  <input
                    ...
                    value={cardToAdd.cvc}
                    onChange={(e) =>
                      setCardToAdd({ ...cardToAdd, cvc: e.target.value })
                    }
                    onFocus={(e) => setFocus(e.target.name)}
                  />
                </div>
            ...
            <div className="zip-div">
              <label htmlFor="zip" style={{ marginBottom: "2%" }}>
                Zip Code
              </label>
              <input
                type="tel"
                ...
                value={cardToAdd.zip}
                onChange={(e) =>
                  setCardToAdd({ ...cardToAdd, zip: e.target.value })
                }
                onFocus={(e) => setFocus(e.target.name)}
              />
            </div>
